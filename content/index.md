...
<div style="display: grid; grid-template-columns: repeat(3, 1fr); grid-template-rows: repeat(2, 1fr); gap: 1.5em; margin-top: 2em; margin-bottom: 2em;">
  <a href="/recipes/bear-necessities/sassenach-spirits/" style="text-align: center; text-decoration: none; color: inherit;">
    <img src="/images/bear-necessities-card.webp" alt="Bear Necessities" loading="lazy" decoding="async" style="width: 100%; aspect-ratio: 1/1; object-fit: cover; max-width: 300px; margin: 0 auto; display: block; border-radius: 8px;" />
